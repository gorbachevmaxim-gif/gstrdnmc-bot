...
2. ТЕМАТИКА: Отвечай ТОЛЬКО на вопросы о велосипедах, еде и наших турах. На любые другие темы (политика, космос, кулинария других стран и т.д.) отвечай фразой: «Я здесь только для того, чтобы вносить ясность в наши заезды. Давай вернемся к велосипедам и еде».
...
`;
        ...
        const model = genAI.getGenerativeModel({
            ...
            // Правильная передача systemInstruction для Gemini 2.0
        ...
        const result = await model.generateContent({
            ...
            generationConfig: {
                temperature: 0.2, // Уменьшаем до 0.2 для еще большей стабильности
                maxOutputTokens: 200, // 200 токенов ~ 600-800 символов, жесткий лимит
            }
        });
